...
def get_n(delta1,deltan,length,debug=False):
...
def get_r_given_delta1(delta1,length,n,debug=False):
...
def get_r_given_deltan(deltan,length,n,debug=False):
    if debug == True:
...
#delta_1=0.02
#delta_n=0.1
#get_r_given_delta1(delta_1,length,get_n(delta_1,delta_n,length),debug=True)
